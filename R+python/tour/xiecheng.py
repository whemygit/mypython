...
def load_data(path):
    ...
    comment_address_df={'comments':comments,
            'names':names,
            'addresses':addresses}
    comment_address_df=DataFrame(comment_address_df)
    return df_data,comment_address_df


class trip_model(object):
    def __init__(self,data_path):
        self.data,self.comment_address_df=load_data(data_path)
